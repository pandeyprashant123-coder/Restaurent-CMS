...
const AddNew = () => {
  ...
  const addOptionToVariation = (index: number) => {
    setFormData((prevState) => {
  ...
  const deleteOptionFromVariation = (
  ...
  const handleVariationChange = (
    ...
    setFormData((prevState) => {
      const updatedVariations = [...prevState.variations];
      updatedVariations[index][field] = value as any;
      return { ...prevState, variations: updatedVariations };
    });
  };
          ...
          <div className="flex flex-col gap-5 m-3 bg-white shadow-sm rounded-lg">
            ...
            <div className="m-6 ">
              {formData.variations.map((variation, index) => (
                <div className="p-6 rounded-md bg-slate-50 flex flex-col gap-3">
