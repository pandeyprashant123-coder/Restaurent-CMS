  ...
  return (
    <div className="mx-20 my-8 flex-col ">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-[16px] font-bold dark:text-white ">All Restaurants</h2>
          <p className="text-[#989da3] mb-4 text-[14px]">14 Restaurants near you</p>
        </div>
        {/* Filter buttons */}
        <div className="flex space-x-2 text-[14px]">
          <button className="px-2 py-1 text-gray-500 rounded-md outline outline-2 outline-slate-300">Top Rated</button>
          <button className="px-2 py-1 text-gray-500 rounded-md outline outline-2 outline-slate-300">Discounted</button>
          <button className="px-2 py-1 text-gray-500 rounded-md outline outline-2 outline-slate-300">Veg</button>
          <button className="px-2 py-1 text-gray-500 rounded-md outline outline-2 outline-slate-300">Non-Veg</button>
      ...
      >
        ...
        {/* Details */}
        <div className="mt-6">
          <h3 className="ml-10 font-bold text-[14px] items-center justify-center">{restaurant.name}</h3>
          <div className="flex justify-between mx-10 py-4">
            <div className="flex flex-row gap-x-1 items-center justify-center  text-orange-500 mt-1">
               <IoIosStar/>
               <div className="flex text-white text-[10px] font-bold">{restaurant.rating}</div>
            </div>
      ...
      <div className="flex flex-col items-center justify-center mt-4">
        <button className="bg-orange-500 text-white p-2 rounded-lg" onClick={handleViewMore}>View More</button>
      </div>
      )}
    </div>
  );
