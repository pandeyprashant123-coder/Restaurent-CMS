  ...
  return (
    <div className="mx-28 bg-[#f7e2d6] dark:bg-[#483424] rounded-md -py-8 pt-4 h-48">
      ...
      <div className="flex flex-col px-auto">
        <h2 className="text-lg font-semibold mx-60 pb-4 dark:text-white">Want to Dine In?</h2>
            ...
            {restaurants.map((restaurant, index) => (
              ...
              className="flex flex-row bg-white dark:bg-black rounded-lg p-2 h-fit">
                ...
                className="w-12 h-12 rounded-lg m-2"
                 />
                 <div className=" ">
                 <h3 className="text-sm font-bold mb-2 dark:text-white">{restaurant.name}</h3>
                 <div className="relative max-w-40">
                    <p className="text-sm text-gray-600 mb-1 truncate dark:text-[#727579]">{restaurant.address}</p>
                 </div>
                 ...
                 <div className=" flex justify-center items-center dark:text-white">
                  <img src={route} alt="" className="w-6 h-6 text-[#ff7a1a] ml-4"/>
                  {restaurant.distance}
                 </div>
                 </div>
                 </div>
