...
const cuisines = [
  ...
  { name: "Spanish", image: "https://th.bing.com/th?id=OIP.maQpFJiRuDMauaTZ3N7KiQHaEo&w=316&h=197&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2" },
  { name: "Sea Food", image: "https://th.bing.com/th?id=OIP.maQpFJiRuDMauaTZ3N7KiQHaEo&w=316&h=197&c=8&rs=1&qlt=90&o=6&dpr=1.5&pid=3.1&rm=2" },
];
...
const Cuisines = () => {
  ...
  {cuisines.map((cuisine, index) => (
    ...
    >
      ...
      <div className={` w-[90px] h-[90px] rounded-full overflow-hidden dark:z-10`}>
                <img
                  src={cuisine.image}
                  alt={cuisine.name}
      ...
      <div className="relative bg-white dark:bg-[#141313]  rounded-b-lg shadow-md -mt-4 w-fit cursor-pointer border-[1px] border-red-300 flex items-center justify-center">
        {/* Triangle */}
        <div
          className="absolute -top-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[59px] border-r-[59px] border-b-[40px] border-l-transparent border-r-transparent border-b-orange-500 -mt-8 -z-20 dark:z-0"
        ></div>
