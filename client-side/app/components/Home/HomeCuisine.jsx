  ...
  return (
    <div className="relative mx-28 ">
      ...
      <div className="flex-col space-y-4 mt-4 ">
        <h2 className="relative mt-4 p-4 text-black dark:text-white text-[18px] font-bold z-10">
          Cuisines
        </h2>
        ...
        <div className="items-center justify-center gap-8 py-4 pb-8 my-4 flex flex-wrap dark:bg-[#272727]">
          {cuisines.map((cuisine, index) => (
            ...
            >
              ...
              <div
                className={` w-[90px] h-[90px] rounded-full overflow-hidden z-20`}
              >
                <img
                  src={cuisine.image}
                  alt={cuisine.name}
              ...
              <div className="relative bg-white dark:bg-[#141313]  rounded-b-lg shadow-md -mt-4 w-fit cursor-pointer border-[1px] border-red-300 flex items-center justify-center ">
                {/* Triangle */}
                <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[59px] border-r-[59px] border-b-[40px] border-l-transparent border-r-transparent border-b-orange-500 -mt-8 z-10"></div>
