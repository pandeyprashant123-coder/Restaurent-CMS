...
const middlesectionimage = "assets/img/Fall is coming-rafiki.svg";
const image = "/assets/img/Screenshot (482).png";
const map = ".assets/img/map.png";
const MiddleSection = () => {
  return (
    <div className="flex mx-20 p-2 justify-between">
      ...
      <div className="flex flex-row p-20 -mx-10 w-[60%] bg-[#f5f6f8] dark:bg-background rounded-md  ">
        ...
        <div className="-ml-4 flex justify-center items-center bg-gradientmid rounded-md p-4">
          <button className=" p-3 bg-white justify-center text-orange-500 font-semibold text-[12px] rounded-lg items-center h-fit w-fit whitespace-nowrap">
            Refer Now
          </button>
        </div>
      </div>
