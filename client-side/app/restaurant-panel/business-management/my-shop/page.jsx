...
const banner = "/assets/img/RestroBanner.png";
const icon = "/assets/img/hotelIcon.png";

const hand = "/assets/img/Handshake.png";
const commission = "/assets/img/commission.png";
const vat = "/assets/img/vat.png";
const phone = "/assets/img/phone.png";
const Address = "/assets/img/address.png";
